 ...
 */
contract bscGETtest is Context, AccessControl, ERC20Burnable, ERC20Pausable {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    string public _name = "bscGET smart ticket fuel (testnet)";
    string public _symbol = "bscGETtest";

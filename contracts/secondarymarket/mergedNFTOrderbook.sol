...
import "./OrderbookBuyers.sol";
import "./OrderBookSellers.sol";

contract mergedNFTOrderbook {
  
  address public deployeraddress = msg.sender;
  uint256 public deployertime = now;  
  
  struct GETSecondaryMarket {
      address eventAddress;
      address ticketIssuerAddress;
      uint256 tokenId;
  ...
  constructor(address _getNFTFactoryAddress) public {
      getNFT = ERC721(_NFTAddress);
  }

...
interface ERC721_TICKETING_V3 {
    ...
    function primaryMint(address destinationAddress, address ticketIssuerAddress, address eventAddress, string memory ticketMetadata, uint256 orderTime) external returns (uint256);
    function secondaryTransfer(address originAddress, address destinationAddress, uint256 orderTime) external;

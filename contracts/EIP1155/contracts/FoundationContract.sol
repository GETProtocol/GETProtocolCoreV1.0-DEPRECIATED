...
import "./interfaces/INFT_ERC1155V1.sol";
...
contract FoundationContract is Initializable, ContextUpgradeable {
    ...
    IGET_ERC1155V1 internal GET_ERC1155;
    ...
    function __FoundationContract_init_unchained(address _configurationAddress)
        internal
        initializer
    {
    ...
    function syncConfiguration() external returns (bool) {
        ...
        GET_ERC1155 = IGET_ERC1155V1(CONFIGURATION.getNFT_ERC1155_proxy_address());
